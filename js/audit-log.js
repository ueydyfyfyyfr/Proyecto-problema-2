...
// type: 'INFO' | 'WARNING' | 'SECURITY_ALERT' | 'CONFIG_CHANGE' | 'OPERATION' | 'AI_INTERACTION'
// AI_INTERACTION registra todo intercambio con el agente de IA / n8n (restricción S-7)
